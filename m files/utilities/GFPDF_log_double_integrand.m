function F=GFPDF_log_double_integrand(normZp_full_range,DMAomega,FIMSomega,Zpbinc,ZpDMA,chg,D2_nm,D1_nm,fcond,G,sigma,T_FIMS,T_DMA,P_FIMS,P_DMA,i)
%**************************************************************************
...
PDF=GFPDF_log(D2,D1,fcond,G,sigma);

F=PDF.*omega_FIMS.*omega_DMA./D1_nm./D2_nm;